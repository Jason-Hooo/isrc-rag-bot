...
_SYSTEM_PROMPT = (
    ...
    "   - 呼叫工具時，若能判斷問題類別（可多選），請優先在 `categories` 參數傳入以下陣列元素：文化活動與社群連結、原住民族學生升學管道、獎助學金與行政庶務、學習與校園生活支持、職涯與發展。\n"
...
def _build_search_isrc_knowledge_tool(index: VectorStoreIndex, reranker: JinaRerank) -> FunctionTool:
    ...
    return FunctionTool.from_defaults(
        ...
        description=(
            ...
            "1. 文化活動與社群連結 (包含：文化活動、各類社團運作)\n"
            "2. 原住民族學生升學管道 (包含：升學保障、公費留學辦法)\n"
            "3. 獎助學金與行政庶務 (包含：獎助學金、學雜費減免、住宿權益、各項業務承辦聯絡人)\n"
            "4. 學習與校園生活支持 (包含：心理支持與輔導、身分別變更、希望種子培育計畫、急難救助、課業及學習輔導)\n"
            "5. 職涯與發展 (包含：公職考試資訊、政大公職講座、暑期工讀)"
        ),
    )
